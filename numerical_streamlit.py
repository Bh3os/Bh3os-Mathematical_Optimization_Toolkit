...
from enhanced_numerical_methods import (
    optimize_single_variable, 
    optimize_multivariable, 
    optimize_constrained
)
import matplotlib.pyplot as plt

def add_numerical_methods_to_streamlit():
    """
    Add numerical optimization methods to the streamlit application.
    """
    ...
    if numerical_type == "Single-variable Numerical":
        ...
        with col1:
            ...
            if obj_function_choice == "Select from examples":
                ...
                obj_expr_str = common_obj_functions[selected_obj_function]
            ...
            if constraint_choice == "Select from examples":
                ...
                constraint_expr_str = common_constraints[selected_constraint]
